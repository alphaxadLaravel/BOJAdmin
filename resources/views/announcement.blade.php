      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="d-flex justify-content-between mb-3">
              ...
              <div class="search">
                <input type="text" name="name" class="form-control" placeholder="Search Announcements.."  >
              </div>
          </div>
          ...
          <table class="table table-striped text-center">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="d-none d-md-table-cell"><span class="text-primary">20/05/2022</span></td>
