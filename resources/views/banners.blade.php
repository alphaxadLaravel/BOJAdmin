      ...
      <div class="card">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center">
           <h6 class="card-title">All Slide Banners</h6>
          ...
          <div class="d-flex justify-content-between mb-3">
              ...
              <div class="search">
                <input type="text" name="name" class="form-control" placeholder="Search Banner.."  >
              </div>
          </div>
            ...
            <tbody>
              @for ($i = 0; $i < 10; $i++)
                <tr>
                  ...
                  <td><span class="text-success">Attached</span></td>
