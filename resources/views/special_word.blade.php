...
<div class="pagetitle d-flex justify-content-end">
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Special Words</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
      ...
      <div class="card">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center">
           <h6 class="card-title">All Special  Words</h6>
          ...
          <div class="d-flex justify-content-between mb-3">
              ...
              <div class="search">
                <input type="text" name="name" class="form-control" placeholder="Search special_word.."  >
              </div>
          </div>
